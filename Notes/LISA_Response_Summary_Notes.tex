...
<<<<<<< HEAD:Notes/LISA_Response_Summary_Notes1.tex
\section*{GW signal from a binary}
=======
\section{GW signal from a binary}
>>>>>>> 6e6808b1d3c6051e74363c30f0146964c373a011:Notes/LISA_Response_Summary_Notes.tex
...
\begin{pmatrix}
<<<<<<< HEAD:Notes/LISA_Response_Summary_Notes1.tex
  \frac12(1+\cos^2\iota) \cos(\omega t) \\
  \cos\iota \sin(\omega t)
=======
  \frac12(1+\cos^2\iota) \\
  \cos\iota
>>>>>>> 6e6808b1d3c6051e74363c30f0146964c373a011:Notes/LISA_Response_Summary_Notes.tex
...
For very small frequency, $\tau$ is of the order of one.
>>>>>>> 6e6808b1d3c6051e74363c30f0146964c373a011:Notes/LISA_Response_Summary_Notes.tex
...
Substituting eq[1] in eq[3],the strain equation becomes:
\begin{equation}
\frac{\delta L}{L}=frac{A(t) sin^2 \theta \tau(cos \theta,f)}{2d} \left( \sqrt{ \frac{(1+cos^2 i)^2}{4} cos^2 2\psi  + cos^2 i sin^2 2\psi} \right)cos(\Phi(t)-\Psi)
\end{equation}
