...
\begin{equation}
  ds^2 = -c^2 dt^2 + dz^2
  + (1 + h\cos2\psi) dx^2 + (1 - h\cos2\psi) dy^2 - h\sin2\psi dx\,dy
\end{equation}


\begin{equation}
  h(t) = \frac{4G\mu v^2}{c^4 D} \Big( {\textstyle\frac12}(1+\cos^2\iota)
       + i\cos\iota \Big) \exp(i\omega t)
\end{equation}

\begin{equation}
  \frac{\delta L}L = \tau(\omega,\theta,L) \, \cos2\psi \, h(t)
\end{equation}
where
\begin{equation}
\begin{aligned}
